...
class Leave(models.Model):
    ...
    from_date = fields.Date(string="From Date", required=True, default=datetime.now().strftime("%Y-%m-%d"))
    till_date = fields.Date(string="Till Date", required=True, default=datetime.now().strftime("%Y-%m-%d"))
